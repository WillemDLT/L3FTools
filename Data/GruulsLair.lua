    ...
    sections = {
        {
            ...
            npcs = {
                { id = 18831, name = "High King Maulgar",  kind = "boss", marks = {8},
                ...
                { id = 18832, name = "Krosh Firehand",     kind = "boss", marks = {7},
                ...
                { id = 18835, name = "Kiggler the Crazed", kind = "boss", marks = {6},
                ...
                { id = 18836, name = "Blindeye the Seer",  kind = "boss", marks = {5},
                ...
                { id = 18834, name = "Olm the Summoner",   kind = "boss", marks = {4},
        ...
        },
        {
            name = "Gruul",
            npcs = {
                { id = 19044, name = "Gruul the Dragonkiller", kind = "boss", marks = {8},
        ...
        },
        {
            name = "Trash",
            npcs = {
                { id = 19389, name = "Lair Brute",       kind = "trash", marks = TRASH,
                ...
                { id = 21350, name = "Gronn-Priest",     kind = "trash", marks = TRASH,
                ...
                { id = 18847, name = "Wild Fel Stalker", kind = "boss", marks = TRASH,
