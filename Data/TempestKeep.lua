    ...
    sections = {
        {
            ...
            npcs = {
                ...
                { id = 19516, name = "Void Reaver",               marks = {8},
                ...
                { id = 18805, name = "High Astromancer Solarian", marks = {8},
                ...
                { id = 19622, name = "Kael'thas Sunstrider",      marks = {8},
        ...
        },
        {
            ...
            npcs = {
                { id = 20064, name = "Thaladred the Darkener",      marks = {8},
                  spells = { 36965, 36966 },
                ...
                { id = 20060, name = "Lord Sanguinar",              marks = {7},
                  spells = { 39427 },
                ...
                { id = 20062, name = "Grand Astromancer Capernian", marks = {6},
                ...
                { id = 20063, name = "Master Engineer Telonicus",   marks = {5},
                  spells = { 37036, 37027 },
        ...
        },
        {
            ...
            npcs = {
                { id = 21272, name = "Warp Slicer",        marks = {8},
                  spells = { 36991 },
                ...
                { id = 21271, name = "Infinity Blades",    marks = {7},
                  spells = { 674 },
                ...
                { id = 21273, name = "Phaseshift Bulwark", marks = {6},
                  spells = {},
                ...
                { id = 21268, name = "Netherstrand Longbow", marks = {5},
                  spells = { 2643 },
                ...
                { id = 21269, name = "Devastation",          marks = {4},
                  spells = { 36982 },
                ...
                { id = 21274, name = "Staff of Disintegration", marks = {3},
                  spells = { 36989, 36990 },
                ...
                { id = 21270, name = "Cosmic Infuser",       marks = {2},
                  spells = { 36983, 36985 },
        ...
        },
        {
            ...
            npcs = {
                { id = 18806, name = "Solarium Priest",        marks = TRASH,
                  spells = { 25054, 33387 },
                ...
                { id = 20034, name = "Star Scryer",            marks = TRASH,
                  spells = { 37124 },
                ...
                { id = 20043, name = "Apprentice Star Scryer", marks = TRASH,
                ...
                { id = 20044, name = "Novice Astromancer",     marks = TRASH,
                ...
                { id = 20033, name = "Astromancer",            marks = TRASH,
                ...
                { id = 20046, name = "Astromancer Lord",       marks = TRASH,
                ...
                { id = 20045, name = "Nether Scryer",          marks = TRASH,
                  spells = {},
                  notes = "Caster in Crimson Hand packs - retail has reworked all its abilities so no verified TBC spell IDs on Wowhead. Original TBC version cast Mass Mind Control (mass-dispel ready) and a knockback Arcane Blast; immune to all CC so kill last but interrupt MC." },
                { id = 18925, name = "Solarium Agent",         marks = TRASH,
                  spells = {},
        ...
        },
        {
            ...
            npcs = {
                { id = 20036, name = "Bloodwarder Squire",      marks = TRASH,
                  spells = { 39077 },
                ...
                { id = 20032, name = "Bloodwarder Vindicator",  marks = TRASH,
                  spells = { 853 },
                ...
                { id = 19633, name = "Bloodwarder Mender",      marks = TRASH,
                  spells = { 34809 },
                ...
                { id = 20035, name = "Bloodwarder Marshal",     marks = TRASH,
                ...
                { id = 20031, name = "Bloodwarder Legionnaire", marks = TRASH,
        ...
        },
        {
            ...
            npcs = {
                { id = 20048, name = "Crimson Hand Centurion",   marks = TRASH,
                  spells = { 37268, 37271 },
                ...
                { id = 20049, name = "Crimson Hand Blood Knight", marks = TRASH,
                  spells = { 39077 },
                ...
                { id = 20050, name = "Crimson Hand Inquisitor",  marks = TRASH,
                ...
                { id = 20047, name = "Crimson Hand Battle Mage", marks = TRASH,
                  spells = { 37263 },
        ...
        },
        {
            ...
            npcs = {
                { id = 20037, name = "Tempest Falconer",       marks = TRASH,
                  spells = { 36907, 37154 },
                ...
                { id = 20042, name = "Tempest-Smith",          marks = TRASH,
                ...
                { id = 20039, name = "Phoenix-Hawk",           marks = TRASH,
                  spells = { 31475 },
                ...
                { id = 20038, name = "Phoenix-Hawk Hatchling", marks = TRASH,
                  spells = { 31475 },
                ...
                { id = 21364, name = "Phoenix Egg",            marks = TRASH,
                  spells = {},
                ...
                { id = 19551, name = "Ember of Al'ar",         marks = TRASH,
                  spells = { 34133 },
                ...
                { id = 20041, name = "Crystalcore Sentinel",   marks = TRASH,
                  spells = { 37104 },
                ...
                { id = 20052, name = "Crystalcore Mechanic",   marks = TRASH,
                  spells = { 35318, 37121 },
                ...
                { id = 11859, name = "Doomguard",              marks = TRASH,
                  spells = { 15593, 89, 19474 },
                  notes = "Generic warlock-summoned demon. War Stomp (15593) PBAoE knockback + stun, Rain of Fire (19474), Dispel Magic, Cripple (89). Tank away from raid; banish/enslave works." },
            },
        },
    },
})
