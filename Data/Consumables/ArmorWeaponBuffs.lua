-- L3FTools - Armor & Weapon Buffs (Atlas data, generated from WoW Data/consumables/wow_tbc_consumables.md)
local _, L3F = ...
...
L3F.RegisterConsumables({
    ...
    { id = 18262, name = "Elemental Sharpening Stone", nameFR = "Pierre à aiguiser élémentaire", category = "Armor & Weapon Buffs", effect = "+28 melee crit" },
    { id = 34538, name = "Blessed Weapon Coating", nameFR = "Enduit d'arme béni", category = "Armor & Weapon Buffs", effect = "+165 mana on spellcast proc (Quel'Danas only)" },
    { id = 22522, name = "Superior Wizard Oil", nameFR = "Huile de sorcier excellente", category = "Armor & Weapon Buffs", effect = "+42 spell damage" },
    { id = 20749, name = "Brilliant Wizard Oil", nameFR = "Huile de sorcier brillante", category = "Armor & Weapon Buffs", effect = "+36 spell dmg, +14 spell crit" },
    { id = 22521, name = "Superior Mana Oil", nameFR = "Huile de mana excellente", category = "Armor & Weapon Buffs", effect = "+14 MP/5sec" },
    { id = 20748, name = "Brilliant Mana Oil", nameFR = "Huile de mana brillante", category = "Armor & Weapon Buffs", effect = "+25 healing, +12 MP/5sec" },
})
