...
L3F.RegisterConsumables({
    ...
    { id = 27664, name = "Grilled Mudfish", nameFR = "Eperlan grillé", category = "Food", effect = "+20 Agi, +20 Spirit" },
    { id = 27659, name = "Warp Burger", nameFR = "Steak dimensionnel", category = "Food", effect = "+20 Agi, +20 Spirit" },
    { id = 27657, name = "Blackened Basilisk", nameFR = "Basilic noirci", category = "Food", effect = "+23 spell dmg, +20 Spirit" },
    { id = 31673, name = "Crunchy Serpent", nameFR = "Serpent croustillant", category = "Food", effect = "+23 spell dmg, +20 Spirit" },
    { id = 27665, name = "Poached Bluefish", nameFR = "Tassergal poché", category = "Food", effect = "+23 spell dmg, +20 Spirit" },
    { id = 33825, name = "Skullfish Soup", nameFR = "Soupe de poisson-crâne", category = "Food", effect = "+20 spell crit, +20 Spirit" },
