    ...
    sections = {
        {
            name = "Bosses",
            npcs = {
                { id = 21216, name = "Hydross the Unstable",   marks = {8},
                ...
                { id = 21217, name = "The Lurker Below",       marks = {8},
                ...
                { id = 21213, name = "Morogrim Tidewalker",    marks = {8},
                ...
                { id = 21212, name = "Lady Vashj",             marks = {8},
        ...
        },
        {
            ...
            npcs = {
                { id = 21965, name = "Fathom-Guard Tidalvess", marks = {7},
                ...
                { id = 22091, name = "Spitfire Totem",         marks = TRASH,
                  spells = {},
                ...
                { id = 21966, name = "Fathom-Guard Sharkkis",  marks = {6},
                ...
                { id = 21964, name = "Fathom-Guard Caribdis",  marks = {5},
                ...
                { id = 22119, name = "Fathom Lurker",          marks = TRASH,
                  spells = {},
                ...
                { id = 22120, name = "Fathom Sporebat",        marks = TRASH,
                  spells = {},
        ...
        },
        {
            name = "Hydross Adds",
            npcs = {
                { id = 22036, name = "Tainted Spawn of Hydross", marks = TRASH,
                  spells = {},
                  notes = "Spawns on the Nature-phase transition (4 per swap). Nature DoT melee adds - AoE-tankable; mages/locks burn them while Hydross is being shifted." },
                { id = 22035, name = "Pure Spawn of Hydross",    marks = TRASH,
                  spells = {},
                  notes = "Spawns on the Frost-phase transition. Frost-melee adds; same handling as Tainted Spawns but cast Frostbolt at range. AoE down promptly to prevent piling stacks." },
            },
        },
        {
            name = "Leotheras / Vashj Adds",
            npcs = {
                { id = 22056, name = "Coilfang Strider",       marks = TRASH,
                  spells = { 38257 },
                ...
                { id = 22140, name = "Toxic Sporebat",         marks = TRASH,
                  spells = {},
                ...
                { id = 21958, name = "Enchanted Elemental",      marks = TRASH,
                  spells = {},
                ...
                { id = 22009, name = "Tainted Elemental",        marks = TRASH,
                  spells = { 38253 },
                ...
                { id = 21857, name = "Inner Demon",          marks = TRASH,
                  spells = { 39309 },
                ...
                { id = 21218, name = "Vashj'ir Honor Guard", marks = TRASH,
                ...
                { id = 22055, name = "Coilfang Elite",       marks = TRASH,
                  spells = { 38260, 38262 },
        ...
        },
        {
            ...
            npcs = {
                { id = 21253, name = "Tainted Water Elemental",  marks = TRASH,
                  spells = {},
                  notes = "Pre-Hydross room ambient elemental - Frost-school caster, sheepable. Pull singly and tank-and-spank." },
                { id = 21260, name = "Purified Water Elemental", marks = TRASH,
                  spells = {},
                  notes = "Frost water elemental in the entrance area near Hydross. Ranged frost caster - pull to line of sight; banishable if a warlock is available." },

                { id = 21221, name = "Coilfang Beast-Tamer",   marks = TRASH,
                  spells = { 38371 },
                ...
                { id = 21339, name = "Coilfang Hate-Screamer", marks = TRASH,
                  spells = { 38496 },
                ...
                { id = 21246, name = "Serpentshrine Sporebat", marks = TRASH,
                  spells = { 38461 },
                ...
                { id = 21251, name = "Underbog Colossus",      marks = TRASH,
                ...
                { id = 22352, name = "Colossus Rager",         marks = TRASH,
                  spells = {},
                  notes = "Small adds spawned on Underbog Colossus death (one random outcome). Low HP but numerous - AoE down quickly before they reach raid." },
                { id = 22347, name = "Colossus Lurker",        marks = TRASH,
                  spells = {},
                  notes = "Two adds spawned on Underbog Colossus death (another random outcome). Heavier hitters than Ragers - off-tank pickup and burn before re-engaging the next pull." },
            },
        },
        {
            name = "Pre-Lurker Trash (Platforms)",
            npcs = {
                { id = 21220, name = "Coilfang Priestess",     marks = TRASH,
                  spells = { 2060 },
                ...
                { id = 21301, name = "Coilfang Shatterer",     marks = TRASH,
                  spells = { 38591 },
                ...
                { id = 21263, name = "Greyheart Technician",   marks = TRASH,
                  spells = { 38995 },
                ...
                { id = 21865, name = "Coilfang Ambusher",      marks = TRASH,
                  spells = { 37770, 37790 },
                ...
                { id = 21873, name = "Coilfang Guardian",      marks = TRASH,
                ...
                { id = 21508, name = "Coilfang Frenzy",        marks = TRASH,
                  spells = {},
        ...
        },
        {
            ...
            npcs = {
                { id = 21229, name = "Greyheart Tidecaller",    marks = TRASH,
                  spells = { 32690 },
                ...
                { id = 22236, name = "Water Elemental Totem",   marks = TRASH,
                  spells = {},
                ...
                { id = 21230, name = "Greyheart Nether-Mage",   marks = TRASH,
                  spells = { 37109 },
                ...
                { id = 21232, name = "Greyheart Skulker",       marks = TRASH,
                  spells = { 38625 },
                ...
                { id = 21231, name = "Greyheart Shield-Bearer", marks = TRASH,
                  spells = { 38631, 38630 },
                ...
                { id = 21806, name = "Greyheart Spellbinder",   marks = TRASH,
                ...
                { id = 21863, name = "Serpentshrine Lurker",    marks = TRASH,
                  spells = { 38655, 38650 },
                ...
                { id = 21298, name = "Coilfang Serpentguard",   marks = TRASH,
                  spells = { 38599, 38603 },
                ...
                { id = 21299, name = "Coilfang Fathom-Witch",   marks = TRASH,
                  spells = { 39175 },
                ...
                { id = 22250, name = "Rancid Mushroom",         marks = TRASH,
                  spells = { 38652, 38653 },
        ...
        },
        {
            ...
            npcs = {
                { id = 21225, name = "Tidewalker Warrior",     marks = TRASH,
                ...
                { id = 21226, name = "Tidewalker Shaman",      marks = TRASH,
                ...
                { id = 21920, name = "Tidewalker Lurker",      marks = TRASH,
                  spells = { 41932 },
                ...
                { id = 21228, name = "Tidewalker Hydromancer", marks = TRASH,
                ...
                { id = 21227, name = "Tidewalker Harpooner",   marks = TRASH,
                  spells = { 39061, 38661 },
                ...
                { id = 21224, name = "Tidewalker Depth-Seer",  marks = TRASH,
