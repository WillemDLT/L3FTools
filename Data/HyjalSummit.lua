    ...
    sections = {
        {
            name = "Bosses",
            npcs = {
                { id = 17767, name = "Rage Winterchill", kind = "boss", marks = {8},
                ...
                { id = 17808, name = "Anetheron",        kind = "boss", marks = {8},
                ...
                { id = 17888, name = "Kaz'rogal",        kind = "boss", marks = {8},
                ...
                { id = 17842, name = "Azgalor",          kind = "boss", marks = {8},
                ...
                { id = 17968, name = "Archimonde",       kind = "boss", marks = {8},
        ...
        },
        {
            name = "Wave Trash",
            npcs = {
                { id = 17895, name = "Ghoul",              kind = "trash", marks = TRASH,
                  spells = { 31540 },
                ...
                { id = 17897, name = "Crypt Fiend",        kind = "trash", marks = TRASH,
                  spells = { 28622, 31428 },
                ...
                { id = 17898, name = "Abomination",        kind = "trash", marks = TRASH,
                  spells = { 31607, 31610 },
                ...
                { id = 17899, name = "Shadowy Necromancer", kind = "trash", marks = TRASH,
                  spells = { 31627, 31626 },
                ...
                { id = 17905, name = "Banshee",            kind = "trash", marks = TRASH,
                ...
                { id = 17906, name = "Gargoyle",           kind = "trash", marks = TRASH,
                  spells = { 31664 },
                ...
                { id = 17907, name = "Frost Wyrm",         kind = "trash", marks = {8},
                  spells = { 31688 },
                ...
                { id = 17908, name = "Giant Infernal",     kind = "trash", marks = TRASH,
                  spells = { 31723 },
                ...
                { id = 17916, name = "Fel Stalker",        kind = "trash", marks = TRASH,
                  spells = { 31729 },
                ...
                { id = 17864, name = "Lesser Doomguard",   kind = "boss", marks = TRASH,
                  spells = { 31406, 31408 },
