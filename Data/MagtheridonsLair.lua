    ...
    sections = {
        {
            ...
            npcs = {
                { id = 17257, name = "Magtheridon",         marks = {8},
                ...
                { id = 17256, name = "Hellfire Channeler",  marks = {8, 7, 6, 5, 4},
        ...
        },
        {
            name = "Trash & Summons",
            npcs = {
                { id = 18829, name = "Hellfire Warder",   marks = TRASH,
                ...
                { id = 17454, name = "Burning Abyssal",   marks = TRASH,
                  spells = {},
                  notes = "Summoned by Hellfire Channelers during the boss fight (not real trash). Small infernal-style adds that leave a small fire pool on death; can be banished, feared, or kited. Assign warlocks/mages to lock them down so they don't reach the cube clickers." },
                { id = 11859, name = "Doomguard",         marks = TRASH,
                  spells = { 89, 19474 },
                  notes = "Generic warlock-summon demon (Curse of Doom death proc or Ritual of Doom), not native trash to this raid - listed only to mark if a warlock loses control. Applies Cripple (89) and channels Rain of Fire (19474). Banish/re-enslave or burn down immediately." },
            },
        },
    },
})
