...
L3F:RegisterRaid({
    ...
    npcs = {
        { id = 17306, name = "Watchkeeper Gargolmar", kind = "boss", marks = {8},
        ...
        { id = 17308, name = "Omor the Unscarred", kind = "boss", marks = {8},
          level = 70, type = "Demon",
        ...
        { id = 17537, name = "Vazruden the Herald", kind = "boss", marks = {8},
          level = 70, type = "Humanoid",
          spells = { 33051, 30940 },
        ...
        { id = 17536, name = "Nazan", kind = "boss", marks = {8},
