...
L3F:RegisterRaid({
    ...
    npcs = {
        { id = 24723, name = "Selin Fireheart", kind = "boss", marks = {8},
        ...
        { id = 24744, name = "Vexallus", kind = "boss", marks = {8},
        ...
        { id = 24560, name = "Priestess Delrissa", kind = "boss", marks = {8},
          level = 70, type = "Humanoid",
          spells = {},
        ...
        { id = 24664, name = "Kael'thas Sunstrider", kind = "boss", marks = {8},
          level = 70, type = "Humanoid",
